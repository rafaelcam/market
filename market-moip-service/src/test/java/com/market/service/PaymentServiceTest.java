...
public class PaymentServiceTest {
    ...
    @Before
    public void setup() {
        paymentService.setMoipService(moipService);
    }
    ...
    public void shouldCreateOrderResquestTest() {
        ...
        try {
            given(moipService.createPayment(new PaymentRequest())).willReturn(new Payment());

            paymentService.createPayment(orderWrapper, new Order());
        } catch (Exception e) {
            e.printStackTrace();
