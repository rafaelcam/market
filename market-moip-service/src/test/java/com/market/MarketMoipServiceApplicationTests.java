...
public class MarketMoipServiceApplicationTests {
	...
	public void createOrderTest() {
		...
		CustomerWrapper customer = new CustomerWrapper("Joao", "joao@joao.com", "679920020", "Endereço");
		customer.setId(10l);
		PaymentWrapper paymentWrapper = new PaymentWrapper("DIEGO ORNELAS RAMPIM", "4984233050012052", "09", "20", "372");
