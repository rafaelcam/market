...
var CheckoutCartComponent = (function () {
    function CheckoutCartComponent(cartService) {
        this.cartService = cartService;
        this.cart = 'cart';
        this.codeDiscount = "";
    }
    CheckoutCartComponent.prototype.increaseProduct = function (item) {
        this.cartService.addItem(item.product);
    };
    CheckoutCartComponent.prototype.decreaseProduct = function (item) {
