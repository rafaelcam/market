...
declare namespace jasmine {
    ...
    interface SpyAnd {
        ...
        /** By chaining the spy with and.returnValues, all calls to the function will return specific values in cart until it reaches the end of the return values list. */
